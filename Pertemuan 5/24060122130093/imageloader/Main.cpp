...
void initRendering() {
	...
	Image* image = loadBMP("tatang.bmp");
	_textureId = loadTexture(image);
	
	Image* image1 = loadBMP("tatang.bmp");
	_textureId1 = loadTexture(image1);
	
	Image* image2 = loadBMP("tatang.bmp");
	_textureId2 = loadTexture(image2);
	
	Image* image3 = loadBMP("tatang.bmp");
	_textureId3 = loadTexture(image3);
	
	Image* image4 = loadBMP("tatang.bmp");
	_textureId4 = loadTexture(image4);
	
	Image* image5 = loadBMP("tatang.bmp");
