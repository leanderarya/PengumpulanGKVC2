...
void initRendering() {
    ...
    Image* image = loadBMP("gambar1.bmp");
    _textureId = loadTexture(image);

    Image* image1 = loadBMP("gambar2.bmp");
    _textureId1 = loadTexture(image1);

    Image* image2 = loadBMP("gambar3.bmp");
    _textureId2 = loadTexture(image2);

    Image* image3 = loadBMP("gambar4.bmp");
    _textureId3 = loadTexture(image3);

    Image* image4 = loadBMP("gambar5.bmp");
    _textureId4 = loadTexture(image4);

    Image* image5 = loadBMP("gambar6.bmp");
