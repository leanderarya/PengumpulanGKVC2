...
void draw() {
    ...
    // Sisi tegak
    // Titik atas limas
    float topVertex[3] = {0.0, 40.0, 0.0};

    // Menggambar sisi-sisi limas
    // Gunakan vektor normal yang dihasilkan dari cross product antara vektor atas ke titik sisi dengan vektor atas ke titik alas
    // Ini akan memberikan arah normal yang tepat untuk setiap sisi tegak limas
    glNormal3f(-40.0, -40.0, 40.0);
    glVertex3f(-20.0, -40.0, 20.0);
