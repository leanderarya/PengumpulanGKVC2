...
void Mobil3D()
{
    ...
    // Sisi kanan/kiri
    glPushMatrix();
    glColor3f(0.1, 0.3, 0.8); // Warna biru 
    glBegin(GL_QUADS);
    glVertex3f(-4.0f, 4.5f, 1.9f);
    glVertex3f(4.0f, 4.5f, 1.9f);
    glVertex3f(4.0f, 0.5f, 1.9f);
    glVertex3f(-4.0f, 0.5f, 1.9f);
    glEnd();
    glPopMatrix();
    ...
    // Kaca depan
    glPushMatrix();
    glColor3f(0.5, 0.7, 1.0); // biru muda
    glBegin(GL_QUADS);
    glVertex3f(-4.0f, 4.5f, 1.9f);
    glVertex3f(-4.0f, 4.5f, -1.9f);
    glVertex3f(-4.0f, 1.9f, -1.9f);
    ...
    glTranslatef(-4.0f, 1.0f, 1.7f);
    glutSolidSphere(0.1, 10, 10);
    glPopMatrix();

    glPushMatrix();
    glColor3f(1.0, 1.0, 0.0);
    glTranslatef(-4.0f, 1.0f, 1.3f);
    glutSolidSphere(0.1, 10, 10);
    glPopMatrix();
