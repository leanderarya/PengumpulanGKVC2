 ...
 *Deskripsi : File main menampikan kubus kubus yang setiap sisinya berisi sebuah gambar yang berbeda*/
...
void initRendering() {
    ...
    Image* image = loadBMP("bg11.bmp");
    _textureId = loadTexture(image);

    Image* image1 = loadBMP("bg44.bmp");
    _textureId1 = loadTexture(image1);

    Image* image2 = loadBMP("bg33.bmp");
    _textureId2 = loadTexture(image2);

    Image* image3 = loadBMP("bg55.bmp");
    _textureId3 = loadTexture(image3);

    Image* image4 = loadBMP("bg22.bmp");
    _textureId4 = loadTexture(image4);

    Image* image5 = loadBMP("bg66.bmp");
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Texture With Image - Rania 24060122120013");
    initRendering();
