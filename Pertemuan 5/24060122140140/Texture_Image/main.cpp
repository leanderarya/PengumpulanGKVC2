...
Image* image = loadBMP("Radiohead.bmp");
_textureId = loadTexture(image);

Image* image1 = loadBMP("Radiohead.bmp");
_textureId1 = loadTexture(image1);

Image* image2 = loadBMP("Radiohead.bmp");
_textureId2 = loadTexture(image2);

Image* image3 = loadBMP("Radiohead.bmp");
_textureId3 = loadTexture(image3);

Image* image4 = loadBMP("Radiohead.bmp");
_textureId4 = loadTexture(image4);

Image* image5 = loadBMP("Radiohead.bmp");
